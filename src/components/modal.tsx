...
export const Modal = component$((props: { onClose: () => void }) => {
  return (
    <div
          ...
          <div class="bg-white dark:bg-black px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="text-center sm:text-left pb-4">
              ...
              <div class="flex flex-col gap-3 text-sm mt-4 w-full justify-between text-black dark:text-white">
                Wrong-Lang เป็นโปรแกรมที่ไว้แปลงหรือสลับภาษาหากคุณลืมเปลี่ยนภาษา
                <br /> คล้าย ๆ กับ Lullar's de = กำ หรือ RightLang
              </div>
            </div>
            <hr />
            <div class="text-center sm:text-left mt-8">
              ...
              <center>
                <iframe
                  ...
                  height="302"
                  src="https://www.youtube.com/embed/ZVRpdAv-EyI"
